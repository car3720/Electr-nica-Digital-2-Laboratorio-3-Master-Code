...
// Hardware: Atmega328P
// Created: 23/07/2026 17:57:48
//***************************************************************************
// Laboratorio 3 - Comunicación SPI
// Librería SPI para Maestro archivo .c
//***************************************************************************
...
void SPI_init(uint8_t mode, uint8_t data_order, uint8_t clock_polarity, uint8_t clock_phase) {
	if(mode == SPI_MASTER) {
		...
		DDRB |= (1 << DDB2);               // SS como salida (aunque uses PC0 manual)
		// habilita SPI, maestro y velocidad fosc/16
